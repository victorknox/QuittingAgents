...
class GoogleHomeSearchDevices(VirtualFunctionTool):
    ...
    summary: str = "Searches for smart home devices connected to the user's Google Home."
    parameters: List[ArgParameter] = [
        {
            "name": "device_type",
            "type": "string",
...
class GoogleHomePlayMedia(VirtualFunctionTool):
    ...
    summary: str = "Plays specified media (music, podcasts, etc.) on a connected device."
    parameters: List[ArgParameter] = [
        {
            "name": "media",
            "type": "string",
...
class DropboxListFilesAndFolders(VirtualFunctionTool):
    ...
    summary: str = "List files and folders in a given folder in the user's Dropbox account."
    parameters: List[ArgParameter] = [
        {
            "name": "cloud_folder_path",
            "type": "string",
...
class DropboxDisableLink(VirtualFunctionTool):
    ...
    summary: str = "Disable the shareable link for a file or folder in the cloud storage."
    parameters: List[ArgParameter] = [
        {
            "name": "item_path",
            "type": "string",
...
class TeladocViewReviews(VirtualFunctionTool):
    ...
    summary: str = "View reviews for a doctor by providing the doctor's unique identifier."
    parameters: List[ArgParameter] = [
        {
            "name": "doctor_id",
            "type": "string",
...
class VenmoWithdrawMoney(VirtualFunctionTool):
    ...
    summary: str = "Withdraw money from the user's Venmo balance to a linked bank account."
    parameters: List[ArgParameter] = [
        {
            "name": "amount",
            "type": "number",
...
class WebBrowserGetElementsDetails(VirtualFunctionTool):
    ...
    summary: str = "Retrieves the details of a list of elements in the current web page."
    parameters: List[ArgParameter] = [
        {
            "name": "element_ids",
            "type": "array",
...
class GoogleMapSearchLocations(VirtualFunctionTool):
    ...
    summary: str = "Search for locations using keywords, distance, open status, and rating."
    parameters: List[ArgParameter] = [
        {
            "name": "keywords",
            "type": "string",
...
class EmergencyDispatchSystemSearchIncidents(VirtualFunctionTool):
    ...
    summary: str = "Search for incidents based on a specified location and incident type."
    parameters: List[ArgParameter] = [
        {
            "name": "location",
            "type": "string",
...
class EthereumManagerCallSmartContractFunction(VirtualFunctionTool):
    ...
    summary: str = "Interact with a deployed smart contract by calling one of its functions."
    parameters: List[ArgParameter] = [
        {
            "name": "contract_address",
            "type": "string",
...
class ShopifyGetStoreAnalytics(VirtualFunctionTool):
    ...
    summary: str = "Retrieve store analytics data, such as revenue, orders, and traffic."
    parameters: List[ArgParameter] = [
        {
            "name": "start_date",
            "type": "string",
...
class CiscoUmbrellaSearchLogs(VirtualFunctionTool):
    ...
    summary: str = "Search for security logs based on a keyword, date range, or event type."
    parameters: List[ArgParameter] = [
        {
            "name": "keyword",
            "type": "string",
...
class SpokeoBackgroundCheck(VirtualFunctionTool):
    ...
    summary: str = "Perform a background check on a person using their unique identifier."
    parameters: List[ArgParameter] = [
        {
            "name": "unique_id",
            "type": "string",
